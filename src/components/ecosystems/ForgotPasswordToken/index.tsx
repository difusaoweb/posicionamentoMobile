...
interface ForgotPasswordTokenProps {
  navigation: StackNavigationProp<{}>
}
const ForgotPasswordToken = ({ navigation }: ForgotPasswordTokenProps) => {
  ...
  return (
    <>
      <View style={[styles.row, styles.justifyContentCenter]}>
        <Title style={styles.description}>{t('Insiria o código abixo:')}</Title>
      </View>
